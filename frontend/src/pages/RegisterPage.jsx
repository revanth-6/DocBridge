          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                <label className="block text-slate-400 text-sm font-medium mb-1">First Name</label>
                <Input
                  placeholder="John"
              ...
              <div className="space-y-1">
                <label className="block text-slate-400 text-sm font-medium mb-1">Last Name</label>
                <Input
                  placeholder="Doe"
                  value={form.lastName}
