...
export default function LoginPage() {
  ...
  return (
    <div className="h-screen bg-slate-950 flex flex-col lg:flex-row text-white overflow-hidden font-sans relative">
      {/* Left Panel — The Showcase Side */}
      <div className="hidden lg:flex lg:w-[55%] relative flex-col justify-between py-12 px-12 xl:px-16 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 overflow-hidden border-r border-white/5 h-full">
        {/* Animated Glow Orbs */}
        ...
        >
          ...
          >
            Your health,<br />
            <span className="bg-gradient-to-r from-teal-400 via-cyan-400 to-emerald-400 bg-clip-text text-transparent">finally clear.</span>
          </motion.h1>
          ...
          >
            Stop leaving doctor visits confused. DocBridge translates your medical world into language you actually understand.
          </motion.p>
      ...
      <div className="flex-1 lg:w-[45%] flex items-center justify-center p-6 sm:p-12 lg:p-16 bg-slate-900/60 border-l border-white/5 h-full relative overflow-y-auto">
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-slate-400 text-sm mb-4">Sign in to your health dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <motion.button
              ...
              disabled={loading}
              type="submit"
              className="w-full bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-400 hover:to-cyan-400 text-white font-semibold rounded-xl py-3 shadow-lg shadow-teal-500/25 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-4"
            >
              {loading ? (
          ...
          <p className="text-center text-sm text-slate-400">
            ...
            <Link to="/register" className="text-teal-400 hover:text-teal-300 font-medium hover:underline transition-colors duration-200">
              Create one for free →
            </Link>
          </p>
        </motion.div>
